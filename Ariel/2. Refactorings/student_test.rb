...
class StudentTest < Minitest::Test
  ...
  def setup
    ...
    @student2 = Student.new(name: 'Mary', anual_income: 25_000, id: 222)
  ...
  def test_scholarship_worthy?
    ...
    assert_equal 'No available grades', (assert_raises(RuntimeError) { @student2.scholarship_worthy? }).message
