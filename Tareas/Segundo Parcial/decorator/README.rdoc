...
<b>Decorator Pattern</b> enables you to easily add an enhancement to an existing object. 
The <b>Decorator pattern</b> also allows you to layer features atop one another so that 
you can construct objects that have exactly the right set of capabilities that you need 
