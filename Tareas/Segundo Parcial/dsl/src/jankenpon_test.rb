...
# implementation of the <em>Domain-Specific Language (DSL)  Pattern</em>.
class JakenponTest < Minitest::Test
    
  #Prepares the data for creating the JakenponTest
  def setup
    @old_stdout = $stdout
  ...
  #Test the creation of a Spock instance
  def test_dsl_1
    #---------
    show Spock
    #---------
   ...
   #Test the operation Spock + Lizard
   def test_dsl_2
       #------------------
       show Spock + Lizard
        #------------------
   ...
   def test_dsl_3
    ...
    #Test the operation Spock + Lizard + Rock
  def test_dsl_4
     #-------------------------
  ...
  def test_dsl_5
    ...
    #Test the operation Rock + Paper + Scissors + Lizard + Spock
  def test_dsl_6
    #--------------------------------------------
  ...
  def test_dsl_8
    ...
    #Test the operation  Paper + ((Spock + Paper) - Lizard + Rock)
  def test_dsl_9
    #---------------------------------------------
