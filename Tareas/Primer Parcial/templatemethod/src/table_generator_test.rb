...
# correct implementation for the <em>template 
# pattern</em> with the TableGenerator Example.

class TableGeneratorTest < Minitest::Test
  
  #Prepares the attributes for the tests. 
  ...
  #Calls to the test of +CSVTableGenerator+ and verifies it is valid.
  ...
  #Calls to the test of +HTMLTableGenerator+ and verifies it is valid.
  ...
  #Calls to the test of +AsciiDocTableGenerator+ and verifies it is valid.
